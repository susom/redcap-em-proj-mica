...
|---|---|---|---|
| 0 — Foundations | [`stage-0-foundations.md`](stage-0-foundations.md) | — | **in progress** — 0.1–0.4 + 0.5b done, PHPUnit half of 0.5 done; remaining: CI workflow + phpcs baseline (0.5), cleanup (0.6) |
