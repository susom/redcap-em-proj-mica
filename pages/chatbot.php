...
if (!empty($data)) $cmds[] = "window.mica_jsmo_module.data = " . json_encode($data);
if (!empty($init_method)) $cmds[] = "window.mica_jsmo_module.afterRender(mica_jsmo_module." . $init_method . ")";
?>
<html lang="en">
<head>
    <meta charset="UTF-8" />
